...
class TaxonomiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create taxonomy" do
    assert_difference('Taxonomy.count') do
      post taxonomies_url, params: { taxonomy: { count: @taxonomy.count, description: @taxonomy.description, taxonomy: @taxonomy.taxonomy, term_id: @taxonomy.term_id } }
    end
  ...
  test "should update taxonomy" do
    patch taxonomy_url(@taxonomy), params: { taxonomy: { count: @taxonomy.count, description: @taxonomy.description, taxonomy: @taxonomy.taxonomy, term_id: @taxonomy.term_id } }
